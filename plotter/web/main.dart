...
class _ArrowAdder implements PlotterMouseHandle {
  static const MouseButtonState _state = MouseButtonStateImpl(
    button: 0,
    altKey: true,
  );
...
class _PointAdder implements PlotterMouseHandle {
  ...
  static const MouseButtonStateImpl _state = MouseButtonStateImpl(
    button: 0,
    shiftKey: true,
  );
