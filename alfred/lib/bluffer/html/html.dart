...
String htmlElementToString({
  ...
  if (element is HtmlElementRaw) {
    ...
    final tag = element_tag(
      element: element,
    );
    return "<" + () {
      final className = element_classname(
        element: element,
      );
      final id = element_id(
        element: element,
          ...
          content.match(
            ...
            serializeKey(
              key: a.content.key,
                ...
                " }\n",
            structure: (final a) => serializeKey(key: a.key) + " { " + <String>[
...
List<HtmlEntity> element_child_nodes({
  required final HtmlElement element,
}) =>
    element.match(
      appended: (final a) => [
      ...
      raw: (final a) => [],
      copy: (final a) => element_child_nodes(
        element: a.other,
      ),
      br: (final a) => [],
