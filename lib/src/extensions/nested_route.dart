...
extension NestedRouteExtension on Alfred {
  ...
  NestedRoute route(String path,
          {List<FutureOr<dynamic> Function(HttpRequest req, HttpResponse res)>
              middleware = const []}) =>
...
class NestedRoute {
  ...
  final List<FutureOr<dynamic> Function(HttpRequest req, HttpResponse res)>
      _baseMiddleware;

  NestedRoute(
      {required Alfred alfred,
      required String basePath,
      required List<FutureOr<dynamic> Function(HttpRequest req, HttpResponse res)>
          baseMiddleware})
      : _alfred = alfred,
        _basePath = basePath,
  ...
  HttpRoute _createRoute(
      ...
      FutureOr<dynamic> Function(HttpRequest req, HttpResponse res) callback,
      Method method,
      [List<FutureOr<dynamic> Function(HttpRequest req, HttpResponse res)> middleware =
          const []]) {
