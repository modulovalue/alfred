...
class FontWeight {
  ...
  static const List<FontWeight> values = <FontWeight>[w100, w200, w300, w400, w500, w600, w700, w800, w900];
...
class FontFeature {
  ...
  const FontFeature(this.feature, [this.value = 1])
      : assert(feature.length == 4, "The given feature must have exactly 4 characters."),
...
class TextStyle {
  ...
  @override
  int get hashCode => hashValues(color, fontWeight, fontStyle, decorationColor, decoration, decorationStyle, fontFamily, fontFamilyFallback,
      fontSize, letterSpacing, wordSpacing, height, locale, decorationThickness);
...
class TextRange {
  ...
  const TextRange({
    required this.start,
    required this.end,
  })  : assert(start >= -1, "The given start position $start must either be -1, 0 or positive"),
        assert(end >= -1, "The given end position $end must either be -1, 0 or positive");
